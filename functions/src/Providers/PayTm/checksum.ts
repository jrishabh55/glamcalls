...
function paramsToStringrefund(params, mandatoryflag = false) {
  let data = '';
  const tempKeys = Object.keys(params);
  tempKeys.sort();
  tempKeys.forEach(function (key) {
...
export { genchecksum as genchecksum }
export { verifychecksum as verifychecksum }
export { verifychecksumbystring as verifychecksumbystring }
export { genchecksumbystring as genchecksumbystring }
export { genchecksumforrefund as genchecksumforrefund }
